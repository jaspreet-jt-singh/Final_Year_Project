...
\begin{itemize}
    ...
    \item A final YOLO11s detector with 0.830 validation mAP@50 and 0.820 held-out test mAP@50.
    \item Held-out test mAP@50:95 of 0.680 for the 72-class detector.
