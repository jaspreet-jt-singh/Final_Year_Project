...
The project was implemented as a full-stack application rather than only a training notebook. This made the work closer to a usable prototype, but it also created consistency problems that had to be checked repeatedly. A small class-name change in the dataset, for example, also required checking the nutrition mapping, backend response, and frontend display name. The backend uses Python, FastAPI, PyTorch, Ultralytics YOLO, Pillow, NumPy, Pandas, OpenPyXL, SQLite, and AioSQLite. The frontend uses Next.js, React, TypeScript, Tailwind CSS, and Lucide icons. The repository is organized into \code{backend/}, \code{frontend/}, \code{data/}, \code{models/}, \code{scripts/}, and \code{notebooks/} so that model assets, data processing, API code, and interface code remain separated.
