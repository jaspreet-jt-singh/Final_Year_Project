...
try {
  ...
  for (const [name, message] of [['limited', 'Too many requests. Please wait a minute and try again.'], ['invalid', 'Invalid image from server'], ['none', 'No food detected in this image.']]) {
    scenario = name
